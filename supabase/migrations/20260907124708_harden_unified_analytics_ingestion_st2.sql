...
-- Anonymous/signed-in browsers still use track-event; the Edge Function verifies any user JWT
-- and passes the verified viewer id through an internal metadata field that is stripped before storage.
...
begin
  ...
  insert into public.analytics_events(
    ...
    v_metadata,false,nullif(left(coalesce(p_device_type,''),30),''),nullif(left(coalesce(p_os,''),60),''),
