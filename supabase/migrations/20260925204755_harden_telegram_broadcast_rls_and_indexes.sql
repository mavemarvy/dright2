...
create index if not exists telegram_broadcast_campaigns_created_by_idx on public.telegram_broadcast_campaigns(created_by);
create index if not exists telegram_broadcast_join_requests_decided_by_idx on public.telegram_broadcast_join_requests(decided_by);
create index if not exists telegram_broadcast_settings_updated_by_idx on public.telegram_broadcast_settings(updated_by);
