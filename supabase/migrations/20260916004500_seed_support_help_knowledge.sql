-- Initial operational support knowledge for Help Center and grounded AI Support.
-- This intentionally documents only implemented support behavior and does not invent business-policy decisions.
