...
import PlatformFeatureGate from './components/PlatformFeatureGate';
import { NavigationVisibilityProvider } from './contexts/NavigationVisibilityContext';
import { AIMasterProvider, AIMasterGate } from './contexts/AIMasterContext';
import ProtectedRoute from './components/ProtectedRoute';
import UserNavigationRouteGate from './components/UserNavigationRouteGate';
...
import NetworkRiskReporter from './components/NetworkRiskReporter';
...
const SocialFieldPage = lazy(() => import('./pages/SocialFieldPage'));
...
const AdminListingVerificationPage = lazy(() => import('./pages/admin/AdminListingVerificationPage'));
...
const AdminUserNavigationPage = lazy(() => import('./pages/admin/AdminUserNavigationPage'));
...
const AdminDrightStorePage = lazy(() => import('./pages/admin/AdminDrightStorePage'));
...
const AdminPromotionDistributionPage = lazy(() => import('./pages/admin/AdminPromotionDistributionPage'));
...
<Route element={<ProtectedRoute><UserNavigationRouteGate><AppShell/></UserNavigationRouteGate></ProtectedRoute>}><Route path="/" element={<DashboardPage/>}/><Route path="/social/*" element={<SocialFieldPage/>}/><Route path="/news" element={<AnnouncementsPage/>}/><Route path="/communities" element={<CommunitiesPage/>}/><Route path="/communities/create" element={<CommunityCreatePage/>}/><Route path="/communities/:slug" element={<CommunityDetailPage/>}/><Route path="/store" element={<PlatformFeatureGate featureKey="seller_product_listing" title="Seller Platform Access Required"><StorePage/></PlatformFeatureGate>}/><Route path="/upload-product" element={<PlatformFeatureGate featureKey="seller_product_listing" title="Seller Platform Access Required"><UploadProductPage/></PlatformFeatureGate>}/><Route path="/drafts" element={<DraftsPage/>}/><Route path="/post-job" element={<PlatformFeatureGate featureKey="employer_job_posting" title="Employer Subscription Required"><JobPostingPage/></PlatformFeatureGate>}/><Route path="/product/:id/edit" element={<PlatformFeatureGate featureKey="seller_product_listing" title="Seller Platform Access Required"><EditProductPage/></PlatformFeatureGate>}/><Route path="/my-orders" element={<BuyerDashboardPage/>}/><Route path="/sales" element={<SalesPage/>}/><Route path="/verify" element={<VerifyPage/>}/><Route path="/profile" element={<ProfilePage/>}/><Route path="/profile/:userId" element={<PublicProfilePage/>}/><Route path="/followers/:userId" element={<FollowersPage/>}/><Route path="/following/:userId" element={<FollowingPage/>}/><Route path="/friends/:userId" element={<FriendsPage/>}/><Route path="/refer" element={<PlatformFeatureGate featureKey="referral_program" title="Referral Platform Access Required"><ReferPage/></PlatformFeatureGate>}/><Route path="/wishlist" element={<WishlistPage/>}/><Route path="/collections" element={<SmartCollectionsPage/>}/><Route path="/compare" element={<ComparePage/>}/><Route path="/chat" element={<ChatPage/>}/><Route path="/blocked-users" element={<BlockedUsersPage/>}/><Route path="/notifications" element={<NotificationsPage/>}/><Route path="/activity" element={<ActivityFeedPage/>}/><Route path="/notification-preferences" element={<NotificationPreferencesPage/>}/><Route path="/security" element={<UserSecurityCenterPage/>}/><Route path="/settings" element={<SettingsPage/>}/><Route path="/campaigns" element={<CampaignDashboardPage/>}/><Route path="/promote" element={<PromotePage/>}/><Route path="/rewards" element={<RewardWalletPage/>}/><Route path="/wallet" element={<WalletPage/>}/><Route path="/wallet/fund" element={<FundWalletPage/>}/><Route path="/wallet/withdraw" element={<WithdrawPage/>}/><Route path="/wallet/history" element={<TransactionHistoryPage/>}/><Route path="/checkout/payment" element={<CheckoutPaymentPage/>}/><Route path="/payment/callback" element={<PaymentCallbackPage/>}/><Route path="/subscriptions/checkout" element={<SubscriptionCheckoutPage/>}/><Route path="/subscriptions" element={<SubscriptionsPage/>}/><Route path="/creator-campaigns" element={<CreatorCampaignsPage/>}/><Route path="/creator-campaigns/create" element={<PlatformFeatureGate featureKey="task_creation" title="Task Creator Subscription Required"><CampaignBuilderPage/></PlatformFeatureGate>}/><Route path="/creator-campaigns/:id" element={<CampaignDetailPage/>}/><Route path="/creator-campaigns/my-tasks" element={<MyTasksPage/>}/><Route path="/creator-campaigns/dashboard" element={<CreatorDashboardPage/>}/><Route path="/creator-campaigns/wallet" element={<CampaignWalletPage/>}/><Route path="/creator-campaigns/leaderboard" element={<LeaderboardPage/>}/><Route path="/leaderboards" element={<TrustLeaderboardPage/>}/><Route path="/achievements" element={<AchievementsPage/>}/></Route>
<Route path="/admin" element={<AdminRoute><AdminShell/></AdminRoute>}><Route index element={<AdminDashboardPage/>}/><Route path="users" element={<AdminUsersPage/>}/><Route path="users/:userId" element={<AdminUserDetailPage/>}/><Route path="products" element={<AdminProductsPage/>}/><Route path="listing-verification" element={<AdminListingVerificationPage/>}/><Route path="product-edits" element={<AdminProductEditsPage/>}/><Route path="verifications" element={<AdminVerificationsPage/>}/><Route path="fraud-reports" element={<AdminFraudReportsPage/>}/><Route path="payouts" element={<AdminPayoutsPage/>}/><Route path="wallet-manager" element={<AdminWalletManagerPage/>}/><Route path="payment-security" element={<AdminPaymentSecurityPage/>}/><Route path="payment-providers" element={<AdminPaymentProvidersPage/>}/><Route path="webhook-logs" element={<AdminWebhookLogsPage/>}/><Route path="payment-analytics" element={<AdminPaymentAnalyticsPage/>}/><Route path="withdrawals" element={<AdminWithdrawalsPage/>}/><Route path="settlements" element={<AdminSettlementsPage/>}/><Route path="admins" element={<AdminAdminsPage/>}/><Route path="invite" element={<AdminInvitePage/>}/><Route path="settings" element={<AdminSystemSettingsPage/>}/><Route path="announcements" element={<AdminAnnouncementsPage/>}/><Route path="site-settings" element={<AdminSiteSettingsPage/>}/><Route path="user-navigation" element={<AdminUserNavigationPage/>}/><Route path="local-seo" element={<AdminLocalSeoPage/>}/><Route path="tickets" element={<AdminTicketsPage/>}/><Route path="reviews" element={<AdminReviewsPage/>}/><Route path="locked-accounts" element={<AdminLockedAccountsPage/>}/><Route path="appeals" element={<AdminAppealsPage/>}/><Route path="referral-analytics" element={<AdminReferralAnalyticsPage/>}/><Route path="competitions" element={<AdminCompetitionsPage/>}/><Route path="marketplace" element={<AdminMarketplacePage/>}/><Route path="dright-store" element={<AdminDrightStorePage/>}/><Route path="subscriptions" element={<AdminSubscriptionsPage/>}/><Route path="notification-center" element={<AdminNotificationCenterPage/>}/><Route path="algorithm" element={<AdminAlgorithmPage/>}/><Route path="promotions" element={<AdminPromotionsPage/>}/><Route path="promotion-distribution" element={<AdminPromotionDistributionPage/>}/><Route path="broadcast" element={<AdminBroadcastPage/>}/><Route path="coupons" element={<AdminCouponsPage/>}/><Route path="giveaways" element={<AdminGiveawaysPage/>}/><Route path="marketplace-analytics" element={<AdminMarketplaceAnalyticsPage/>}/><Route path="moderation" element={<AdminModerationPage/>}/><Route path="fraud" element={<AdminFraudPage/>}/><Route path="financial" element={<AdminFinancialPage/>}/><Route path="financial-center" element={<AdminFinancialCenterPage/>}/><Route path="audit-logs" element={<AdminAuditLogsPage/>}/><Route path="ai" element={<AIMasterGate><AdminAIPage/></AIMasterGate>}/><Route path="ai-config" element={<AdminAIConfigPage/>}/><Route path="ai-prompts" element={<AIMasterGate><AdminPromptLibraryPage/></AIMasterGate>}/><Route path="ai-moderation" element={<AIMasterGate><AdminAIModerationPage/></AIMasterGate>}/><Route path="ai-images" element={<AIMasterGate><AdminAIImagesPage/></AIMasterGate>}/><Route path="env-health" element={<AdminEnvHealthPage/>}/><Route path="system-health" element={<AdminSystemHealthPage/>}/><Route path="auth-center" element={<AdminAuthCenterPage/>}/><Route path="trust-center" element={<AdminTrustCenterPage/>}/><Route path="cms" element={<AdminCmsPage/>}/><Route path="cms/:pageId" element={<AdminCmsPageBuilder/>}/><Route path="cms/media" element={<AdminCmsMediaPage/>}/><Route path="content" element={<AdminContentDashboardPage/>}/><Route path="banners" element={<AdminBannerPage/>}/><Route path="roles" element={<AdminRolesPage/>}/><Route path="moderation-center" element={<AdminModerationCenterPage/>}/><Route path="badges" element={<AdminBadgeManagementPage/>}/><Route path="admin-approval" element={<AdminApprovalWorkflowPage/>}/><Route path="publishing" element={<AdminPublishingWorkflowPage/>}/><Route path="verification-review" element={<AdminVerificationReviewPage/>}/><Route path="verification-providers" element={<AdminVerificationProvidersPage/>}/><Route path="compliance-center" element={<AdminComplianceCenterPage/>}/><Route path="crm" element={<AdminCrmDashboardPage/>}/><Route path="customer-recovery" element={<AdminCustomerRecoveryPage/>}/><Route path="subscription-recovery" element={<AdminSubscriptionRecoveryPage/>}/><Route path="sales-operations" element={<AdminSalesOperationsPage/>}/><Route path="sales-team" element={<AdminSalesTeamPage/>}/><Route path="sales-team/applications" element={<SalesTeamMarketerApplicationsPage/>}/><Route path="customer-care" element={<AdminCustomerCarePage/>}/><Route path="marketing-dashboard" element={<AdminMarketingDashboardPage/>}/><Route path="admin-performance" element={<AdminAdminPerformancePage/>}/><Route path="ai-insights" element={<AIMasterGate><AdminAiInsightsPage/></AIMasterGate>}/><Route path="integration-hub" element={<AdminIntegrationHubPage/>}/><Route path="integration-logs" element={<AdminIntegrationLogsPage/>}/><Route path="enterprise-analytics" element={<AdminEnterpriseAnalyticsPage/>}/><Route path="business-intelligence" element={<AdminBusinessIntelligencePage/>}/><Route path="reports-center" element={<AdminReportsCenterPage/>}/><Route path="customer-analytics" element={<AdminCustomerAnalyticsPage/>}/><Route path="affiliate-analytics" element={<AdminAffiliateAnalyticsPage/>}/><Route path="financial-analytics" element={<AdminFinancialAnalyticsPage/>}/><Route path="support-analytics" element={<AdminSupportAnalyticsPage/>}/><Route path="admin-performance-analytics" element={<AdminAdminPerformanceAnalyticsPage/>}/><Route path="commission-rules" element={<AdminCommissionRulesPage/>}/></Route>
</Routes></Suspense><CookieConsentBanner/><NetworkRiskReporter/><Suspense fallback={null}><AIMasterGate compact><AIAssistant/></AIMasterGate></Suspense><ToastContainer/></BrowserRouter></AIMasterProvider></NavigationVisibilityProvider></AuthProvider></ErrorBoundary>}
export default App;