    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      ...
      {analytics && tab === 'campaigns' && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-4">
            <div className="flex items-center gap-2 mb-1"><Radio className="w-4 h-4 text-sky-500" /><span className="text-xs text-gray-400">Telegram deliveries</span></div>
            <p className="text-2xl font-bold text-gray-900">{analytics.telegram_deliveries.toLocaleString()}</p>
            <p className="text-xs text-gray-400">{analytics.telegram_clicks.toLocaleString()} tracked clicks</p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 p-4">
            ...
            <p className="text-xs text-gray-400">{analytics.email_clicks.toLocaleString()} tracked clicks</p>
          </div>
        </div>
      )}
