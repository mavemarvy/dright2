...
function DrightLogo({ size = 'hero' }: DrightLogoProps) {
  const isHero = size === 'hero';
  const surfaceId = `metal-surface-${size}`;
  const bevelId = `metal-bevel-${size}`;

  return (
    <div
      className={
        isHero
          ? 'relative h-40 w-40 sm:h-44 sm:w-44 rounded-[2rem] p-[3px] bg-gradient-to-br from-white via-slate-400 to-slate-800 shadow-[0_22px_52px_-16px_rgba(0,0,0,0.9),0_0_32px_rgba(59,130,246,0.12)]'
          : 'relative h-10 w-10 rounded-xl p-[2px] bg-gradient-to-br from-white via-slate-400 to-slate-800 shadow-[0_9px_20px_-8px_rgba(0,0,0,0.9)]'
      }
    >
      <div
        className={
          isHero
            ? 'relative flex h-full w-full items-center justify-center overflow-hidden rounded-[1.85rem] bg-gradient-to-b from-neutral-700 via-neutral-950 to-black p-3 shadow-[inset_0_3px_8px_rgba(255,255,255,0.35),inset_0_-9px_18px_rgba(0,0,0,0.95)]'
            : 'relative flex h-full w-full items-center justify-center overflow-hidden rounded-[0.65rem] bg-gradient-to-b from-neutral-700 via-neutral-950 to-black p-1 shadow-[inset_0_2px_4px_rgba(255,255,255,0.32),inset_0_-4px_8px_rgba(0,0,0,0.95)]'
        }
      >
        <div className="pointer-events-none absolute inset-x-0 top-0 h-1/2 bg-gradient-to-b from-white/14 via-white/5 to-transparent" />
        {isHero && (
          <motion.div
            aria-hidden="true"
            className="pointer-events-none absolute -left-[45%] top-[-18%] h-[140%] w-[34%] rotate-[16deg] bg-gradient-to-r from-transparent via-white/13 to-transparent"
            animate={{ x: ['0%', '430%'] }}
        ...
        <svg
          viewBox="0 0 100 100"
          className={isHero ? 'relative z-10 h-28 w-28 sm:h-32 sm:w-32 drop-shadow-[0_11px_16px_rgba(0,0,0,0.95)]' : 'relative z-10 h-7 w-7 drop-shadow-[0_4px_6px_rgba(0,0,0,0.95)]'}
          fill="none"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          <div className="col-span-2">
            <Link to="/welcome" className="inline-flex items-center gap-2.5 mb-4">
              <DrightLogo size="small" />
              <span className="text-lg font-bold tracking-[0.18em] text-gray-900 dark:text-gray-100">DRIGHT</span>
            </Link>
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-100 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        <Link to="/welcome" className="flex items-center gap-2.5 min-w-0">
          <DrightLogo size="small" />
          <span className="hidden min-[380px]:inline text-sm sm:text-base font-bold tracking-[0.2em] text-gray-900 dark:text-gray-100">DRIGHT</span>
        </Link>
